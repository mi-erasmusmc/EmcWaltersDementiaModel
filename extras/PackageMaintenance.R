...
OhdsiRTools::checkUsagePackage("EmcWaltersDementiaModel")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/EmcWaltersDementiaModel.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EmcWaltersDementiaModel.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "EmcWaltersDementiaModel")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("EmcWaltersDementiaModel")
